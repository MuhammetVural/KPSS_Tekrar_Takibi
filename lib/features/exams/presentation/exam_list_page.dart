                  ...
                  child: Column(
                    children: [
                      for (int i = 0; i < exams.length; i++)
                        Expanded(
                          child: Padding(
                            padding: EdgeInsets.only(bottom: i == exams.length - 1 ? 0 : 12),
                            child: _ExamPanel(
                              exam: exams[i],
                              style: _styleFor(exams[i], b),
                              onTap: () => context.router.push(SubjectsRoute(examId: exams[i].id)),
                            ),
                          ),
                        ),
                    ],
              ...
              itemBuilder: (ctx, i) {
                ...
                return SizedBox(
                  ...
                  child: _ExamPanel(
                    exam: e,
                    style: _styleFor(e, b),
                    onTap: () => context.router.push(SubjectsRoute(examId: e.id)),
                  ),
                );
              },
            );
